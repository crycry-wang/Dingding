let data = {
    ...
    // total: 0,
    storeList: [
        { storeID: 1, storeName: "太初麵食", storeScore: 4.3, storePhoto: "../public/image/store/Taichung/太初麵食/index.jpeg", },
        { storeID: 2, storeName: "隨主飡_法式水煮專賣賣賣賣賣賣賣賣賣賣", storeScore: 3.1, storePhoto: "../public/image/store/Taichung/隨主飡_法式水煮專賣/index.jpeg", },
        { storeID: 3, storeName: "朴大哥的韓式炸雞_逢甲總店", storeScore: 3.9, storePhoto: "../public/image/store/Taichung/朴大哥的韓式炸雞_逢甲總店/index.jpeg", }
    ],
    randaomCard: "",
    countCard: "",
    productQuantity: "",
